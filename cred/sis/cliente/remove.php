...
if($_GET['id']) {
  ...
  $sqlDft = "SELECT * FROM clientes WHERE id = {$id}";
...
<div class="col-md-6"><a href="cliente.php"><button class="col-md-6 btn btn-lg btn-info active" type="button">Retornar</button></a></div>

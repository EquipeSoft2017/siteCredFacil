        ...
        <div id="navbar" class="navbar-collapse collapse">
          ...
          <ul class="nav navbar-nav">
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a href="simulacao/simulacao.php">Simulação</a></li>
          ...
          <ul class="nav navbar-nav">
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a href="#">Relatório de Contas a Pagar</a></li>
                <li><a href="#">Relatório de Contas a Receber</a></li>
                <li><a href="#">Relatório de Vendas</a></li>
                <li><a href="#">Relatório de Contratos</a></li>
              </ul>
            </li>
          </ul>
          <ul class="nav navbar-nav navbar-right">
            <li>
              <a><?php
                    $login_session_admin=$_SESSION['login_admin'];
                    echo ($login_session_admin);
                  ?>
              </a>
            </li>
            <li>
